...
/**
 * File extension used for format detection (lowercase, no leading dot).
...
/**
 * Point-cloud URL formats understood by the 3D engine point-cloud entry point
 * (`ogl.prototype.addPointCloudObject`).
 * Extend this union when adding new loaders (e.g. PCD, LAS).
 */
...
/**
 * MODEL_3D (and equivalent) asset formats the engine can load today.
